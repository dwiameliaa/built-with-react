  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-100 p-6 overflow-hidden">
      ...
      <svg
        ...
        // absolute bottom-0 right-[-50px] w-[300px] h-[300px] opacity-50 z-10
      >
        <path
      ...
      <div className="relative z-10 bg-white/30 backdrop-blur-lg rounded-3xl shadow-2xl p-10 w-full max-w-md border border-white/50">
        ...
        <div className="space-y-4 text-center">
          <a
            ...
            className="relative block w-full py-3 px-6 bg-blue-900 text-white rounded-2xl shadow-md border border-white/50 overflow-hidden transition-all duration-300 ease-in-out group"
          >
            ...
            <span className="relative group-hover:text-blue-900">
              Website 🔗
            </span>
          </a>
          <a
